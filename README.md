...
<h2>
  <a href="#">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=FF6347&width=900&lines=👋🏽+Olá,+sou+o+Ygor+Ferreira,+tenho+19+anos.;Atualmente+trabalho+na+CPTM+e+curso+Desenvolvimento+de+Sistemas+no+Senai.;Seja+bem-vindo(a)+ao+meu+perfil+do+GitHub!" alt="Typing SVG"/>
  </a>
</h2>
...
<ul>
  <li><strong>Interfaces Web com Bootstrap:</strong>  
    🔗 <a href="https://ygorfnascimento.github.io/Projeto-Med/" target="_blank">Projeto Med</a>
  </li>
  <li><strong>Microsoft Power BI:</strong>  
    🔗 <a href="https://app.powerbi.com/view?r=eyJrIjoiNmQyYTI5MjktZmM3ZC00NWNkLWI1ZmUtYjgyMTI0ZGNhZDA0IiwidCI6ImIxMDUxYzRiLTNiOTQtNDFhYi05NDQxLWU3M2E3MjM0MmZkZCJ9" target="_blank">Projeto BI</a>
  </li>
  <li><strong>Microsoft Power Platform Fundamentals:</strong>  
    🔗 <a href="https://github.com/Ygorfnascimento/Projeto-Power-Apps" target="_blank">Projeto integrado ao Power BI</a>
  </li>
</ul>
